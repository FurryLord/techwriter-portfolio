...
![Схема структуры поста](../images/styleguide-01.png)
...
![Пример поста для рубрики КОМП.WORD](../images/styleguide-02.png)
...
![Пример поста для рубрики «Ок, ставим библиотеку на КОМП»](../images/styleguide-03.png)
...
![Пример поздравительного поста](../images/styleguide-04.png)
...
![Пример анонса мероприятия](../images/styleguide-05.png)
...
![Пример напоминания об одном мероприятии](../images/styleguide-06.png)
...
![Пример напоминания с коллажем афиш](../images/styleguide-07.png)
...
![Пример рассказа о прошедшем мероприятии](../images/styleguide-08.png)
...
- Названия мероприятий
  ...
  ![Пример выделения названий мероприятий](../images/styleguide-09.png)
  
- Названия произведений

  ![Пример выделения названий произведений жирным шрифтом](../images/styleguide-10.png)

- Имена, занимаемые должности, организации

  ![Пример выделения имён, должностей и организаций жирным шрифтом](../images/styleguide-11.png)

- Пункты программы мероприятия в [основной части](#основная-часть), если нужно сделать акцент на отдельных словах или фразах

  ![Пример выделения пунктов программы мероприятия жирным шрифтом](../images/styleguide-12.png)

- Слова «Дата», «Время», «Место» и другие сведения о мероприятии в [основной части](#основная-часть)

  ![Пример выделения ключевых слов жирным шрифтом](../images/styleguide-13.png)
...
- Текст внутри цитаты, которая находится в разделе [Детали](#детали)
  ...
  ![Пример использования курсива в тексте внутри цитаты](../images/styleguide-14.png)

- Раздел [Подпись](#подпись)

  ![Пример использования курсива в подписи](../images/styleguide-15.png)
...
- скрыть длинное пояснение. В таких случаях публикуем цитату «свёрнутой»
  ...
  ![Пример свёрнутой цитаты](../images/styleguide-16.png)

- написать [напоминание](#напоминания) и выделить в нём краткую информации о мероприятии

  ![Пример использования цитаты для напоминания](../images/styleguide-17.png)

- выделить в разделе [Детали](#детали) блок информации

  ![Пример использования цитаты для выделения деталей](../images/styleguide-18.png)
...
- участников мероприятия (поэтов, музыкантов, диджеев, фотографов и т.д.). Добавляем ссылку на личный канал человека, но только если он разрешил
  ...
  ![Пример ссылки на участников мероприятия](../images/styleguide-19.png)

- архивы с фотографиями с мероприятий

  ![Пример ссылки на архив с фотографиями](../images/styleguide-20.png)

- площадки, на которых проводились мероприятия

  ![Пример ссылки на площадку мероприятия](../images/styleguide-21.png)

- карты с указыванием места, где будет проводиться мероприятие

  ![Пример ссылки на карту с указанием места проведения](../images/styleguide-22.png)

- формы для регистрации, покупки билетов

  ![Пример ссылки на форму регистрации](../images/styleguide-23.png)

- контакты организаторов

  ![Пример ссылки на контакты организаторов](../images/styleguide-24.png)

#### Хештеги {#хештеги}

Хештеги всегда ставятся в самый конец поста:

![Пример использования хештегов](../images/styleguide-25.png)
...
- заголовках в виде эмодзи-букв, которыми для краткости можно заменять [приветствия](#приветствие)
  ...
  ![Пример использования эмодзи-букв в заголовке поста](../images/styleguide-26.png)

  ![Пример использования эмодзи-букв в заголовке поста](../images/styleguide-27.png)

- маркерах списков

  ![Пример использования эмодзи в маркерах списков](../images/styleguide-28.png)
  
- абзацных отступах

  ![Пример использования эмодзи в абзацных отступах](../images/styleguide-29.png)

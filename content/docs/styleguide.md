...
# Стайлгайд для редакторов Казанского Объединения Молодых Поэтов (КОМПа)
...
![Схема структуры поста](/static/images/styleguide-01.png)
...
Также нужно знать, кто занимается афишами и организацией мероприятий – полный список членов отдела SMM находится в разделе [Состав отдела SMM](#cостав-отдела-SMM).
...
![Пример поста для рубрики КОМП.WORD](/static/images/styleguide-02.png)
...
![Пример поста для рубрики «Ок, ставим библиотеку на КОМП»](/static/images/styleguide-03.png)
...
![Пример поздравительного поста](/static/images/styleguide-04.png)
...
![Пример анонса мероприятия](/static/images/styleguide-05.png)
...
![Пример напоминания об одном мероприятии](/static/images/styleguide-06.png)
...
![Пример напоминания с коллажем афиш](/static/images/styleguide-07.png)
...
![Пример рассказа о прошедшем мероприятии](/static/images/styleguide-08.png)
...
- Названия мероприятий
  ...
  ![Пример выделения названий мероприятий](/static/images/styleguide-09.png)
  
- Названия произведений

  ![Пример выделения названий произведений жирным шрифтом](/static/images/styleguide-10.png)

- Имена, занимаемые должности, организации

  ![Пример выделения имён, должностей и организаций жирным шрифтом](/static/images/styleguide-11.png)

- Пункты программы мероприятия в [основной части](#основная-часть), если нужно сделать акцент на отдельных словах или фразах

  ![Пример выделения пунктов программы мероприятия жирным шрифтом](/static/images/styleguide-12.png)

- Слова «Дата», «Время», «Место» и другие сведения о мероприятии в [основной части](#основная-часть)

  ![Пример выделения ключевых слов жирным шрифтом](/static/images/styleguide-13.png)
...
- Текст внутри цитаты, которая находится в разделе [Детали](#детали)
  ...
  ![Пример использования курсива в тексте внутри цитаты](/static/images/styleguide-14.png)

- Раздел [Подпись](#подпись)

  ![Пример использования курсива в подписи](/static/images/styleguide-15.png)
...
- скрыть длинное пояснение. В таких случаях публикуем цитату «свёрнутой»
  ...
  ![Пример свёрнутой цитаты](/static/images/styleguide-16.png)

- написать [напоминание](#напоминания) и выделить в нём краткую информации о мероприятии

  ![Пример использования цитаты для напоминания](/static/images/styleguide-17.png)

- выделить в разделе [Детали](#детали) блок информации

  ![Пример использования цитаты для выделения деталей](/static/images/styleguide-18.png)
...
- участников мероприятия (поэтов, музыкантов, диджеев, фотографов и т.д.). Добавляем ссылку на личный канал человека, но только если он разрешил
  ...
  ![Пример ссылки на участников мероприятия](/static/images/styleguide-19.png)

- архивы с фотографиями с мероприятий

  ![Пример ссылки на архив с фотографиями](/static/images/styleguide-20.png)

- площадки, на которых проводились мероприятия

  ![Пример ссылки на площадку мероприятия](/static/images/styleguide-21.png)

- карты с указыванием места, где будет проводиться мероприятие

  ![Пример ссылки на карту с указанием места проведения](/static/images/styleguide-22.png)

- формы для регистрации, покупки билетов

  ![Пример ссылки на форму регистрации](/static/images/styleguide-23.png)

- контакты организаторов

  ![Пример ссылки на контакты организаторов](/static/images/styleguide-24.png)

#### Хештеги {#хештеги}

Хештеги всегда ставятся в самый конец поста:

![Пример использования хештегов](/static/images/styleguide-25.png)
...
- заголовках в виде эмодзи-букв, которыми для краткости можно заменять [приветствия](#приветствие)
  ...
  ![Пример использования эмодзи-букв в заголовке поста](/static/images/styleguide-26.png)

  ![Пример использования эмодзи-букв в заголовке поста](/static/images/styleguide-27.png)

- маркерах списков

  ![Пример использования эмодзи в маркерах списков](/static/images/styleguide-28.png)
  
- абзацных отступах

  ![Пример использования эмодзи в абзацных отступах](/static/images/styleguide-29.png)
...
### Состав отдела SMM {#cостав-отдела-SMM}
